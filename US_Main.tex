...
\subsubsection{Size of largest connected component}

\subsubsection{Results of impact measures}

\begin{figure}[htp]
    \centering
    \includegraphics[width=15cm]{Results_Impact_Measures_Total.jpg}
    \caption{Result of the impact measures by non-sequential and sequential node removal strategy}
